            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="form-field-1" name="category_name" placeholder="" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea id="form-field-1" name="category_description"   class="col-xs-10 col-sm-5" ></textarea>
                        </div>
                    </div>
