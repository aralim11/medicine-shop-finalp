...
try {
    ace.settings.loadState('main-container')
            ...
            @yield('seller_main_comtent')

            <div class="footer">
                <div class="footer-inner">
                    <div class="footer-content">
                        <span class="bigger-120">
                            <span class="blue bolder">DIU</span>
                            31st-32nd &copy; 2014-2018
                        </span>
...
jQuery(function ($) {
     ...
     */
        ...
        <script src="{{asset('asset/assets/js/daterangepicker.min.js')}}"></script>

        <script src="{{asset('asset/assets/js/bootstrap-datepicker.min.js')}}"></script>
