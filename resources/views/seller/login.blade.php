...
<html lang="en">
    <head>
        ...
        <!-- ace styles -->
        <link rel="stylesheet" href="{{asset('asset/assets/css/ace.min.css')}}" />
    ...
    <body class="login-layout" style="background: #cccccc;">
                        ...
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    ...
                                    <span class="red">MediCare</span>
                                    <span class="white" id="id-text2">Seller</span>
                                </h1>
                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            {!! Form::open(['url' => '/Seller-login-check', 'method'=>'POST']) !!}

                                            <fieldset>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <input type="text" name="seller_email" class="form-control" placeholder="Email" required="" />
                                ...
                                <div id="forgot-box" class="forgot-box widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <form action="{{route('rememberpass')}}" method="post">
                                                {{csrf_field()}}
                                                <fieldset>
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input required="" type="email" name="seller_email" class="form-control" placeholder="Email" />
